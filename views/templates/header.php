    ...
    <header id="top">
        <div class="barre_accessibilite" aria-label="Menu d'accessibilité" role="toolbar">
            ...
            <ul id="liste_accessibilite">
                <li><button type="button" id="btn_taille_texte" class="btn-access" aria-pressed="false">A+ <strong>Augmenter la Taille du texte</strong></button></li>
                <li><button type="button" id="btn_interligne" class="btn-access" aria-pressed="false"><strong>↕ Augmenter l'interligne</strong></button></li>
                <li><button type="button" id="btn_contraste" class="btn-access" aria-pressed="false"><strong>◐ Passer en mode sombre</strong></button></li>
            </ul>
        </div>
